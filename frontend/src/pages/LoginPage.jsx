                        ...
                        >
                                <div className='rounded-2xl border border-payzone-indigo/25 bg-payzone-white/90 py-8 px-4 shadow-lg shadow-payzone-navy/5 backdrop-blur-sm sm:px-10'>
                                        <form onSubmit={handleSubmit} className='space-y-6'>
                                                <div>
                                                        <label htmlFor='email' className='block text-sm font-medium text-payzone-navy/80'>
                                                                {t("auth.login.email")}
                                                        </label>
                                                        <div className='relative mt-1 rounded-md shadow-sm'>
                                                                <div className='pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3'>
                                                                        <Mail className='h-5 w-5 text-payzone-navy/40' aria-hidden='true' />
                                                                </div>
                                                                <input
                                                                        id='email'
                                                                        type='email'
                                                ...
                                                <div>
                                                        <label htmlFor='password' className='block text-sm font-medium text-payzone-navy/80'>
                                                                {t("auth.login.password")}
                                                        </label>
                                                        <div className='relative mt-1 rounded-md shadow-sm'>
                                                                <div className='pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3'>
                                                                        <Lock className='h-5 w-5 text-payzone-navy/40' aria-hidden='true' />
                                                                </div>
                                                                <input
                                                                        id='password'
                                                                        type='password'
                                        ...
                                        <p className='mt-8 text-center text-sm text-payzone-navy/70'>
                                                {t("auth.login.prompt")} {" "}
                                                <Link to='/signup' className='font-medium text-payzone-indigo transition duration-300 hover:text-payzone-navy'>
                                                        {t("auth.login.cta")} {" "}
