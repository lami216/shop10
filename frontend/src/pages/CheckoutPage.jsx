...
const CheckoutPage = () => {
        ...
        const handleSubmit = async (event) => {
                ...
                const STORE_WHATSAPP_NUMBER = "22231585867";
                ...
                <div className='py-10'>
                        <div className='mx-auto flex w-full max-w-5xl flex-col gap-8 px-4 lg:flex-row'>
                                ...
                                >
                                        ...
                                        <form className='space-y-5' onSubmit={handleSubmit}>
                                                <div className='space-y-2'>
                                                        <label className='block text-sm font-medium text-black' htmlFor='customerName'>
                                                        ...
                                                        <input
                                                                ...
                                                                className='w-full rounded-lg border border-payzone-indigo/40 bg-payzone-navy/60 px-4 py-2 text-black placeholder-black focus:border-payzone-gold focus:outline-none focus:ring-2 focus:ring-payzone-indigo'
                                                ...
                                                <div className='space-y-2'>
                                                        <label className='block text-sm font-medium text-black' htmlFor='whatsAppNumber'>
                                ...
                                >
                                        ...
                                        <div className='mt-6 space-y-2 border-t border-white/10 pt-4 text-sm text-black'>
                                        ...
                                        <p className='mt-4 text-xs text-black'>{t("checkout.summary.notice")}</p>
                                </motion.aside>
                        </div>
                </div>
        );
