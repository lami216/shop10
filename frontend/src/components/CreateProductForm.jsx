                        ...
                        <form onSubmit={handleSubmit} className='space-y-4'>
                                <div>
                                        ...
                                        <input
                                                ...
                                                className='mt-1 block w-full rounded-md border border-payzone-indigo/40 bg-payzone-navy/60 px-3 py-2 text-black placeholder-black focus:border-payzone-gold focus:outline-none focus:ring-2 focus:ring-payzone-indigo'
                                                required
                                        />
                                </div>
