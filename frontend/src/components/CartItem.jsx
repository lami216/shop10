                        ...
                        <div className='flex flex-col gap-3'>
                                ...
                                <div className='flex flex-wrap items-center gap-2 text-sm text-black'>
                                        ...
                                        <div className='flex items-center gap-2 text-lg font-semibold text-payzone-gold'>
                                                {isDiscounted && (
                                                        <span className='text-xs font-medium text-black line-through'>
                                ...
                                <div className='flex flex-wrap items-center justify-between gap-3 rounded-xl border border-white/10 bg-payzone-navy/70 px-3 py-2 text-sm text-black'>
